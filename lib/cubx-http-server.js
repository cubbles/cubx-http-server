...
var resolver = require('../lib/cubx-webpackage-resolver');
var storeRemover = require('../lib/cubx-simulated-store-remover');
var url = require('url');
//
...
function CubxHttpServer (options) {
  ...
  if (typeof options.proxy === 'string') {
    if (!options.npu) {
      var npuHttpProxy = process.env.http_proxy || process.env.HTTP_PROXY || null;

      var npuHttpsProxy = process.env.https_proxy || process.env.HTTPS_PROXY || null;
